...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(126, "Не соответствие типов"),
		ERROR_ENTRY(127, "Не мжет быть два GENL"),
		ERROR_ENTRY_NODEF(128),	ERROR_ENTRY_NODEF(129),
		ERROR_ENTRY_NODEF10(130), ERROR_ENTRY_NODEF10(140), ERROR_ENTRY_NODEF10(150),
		ERROR_ENTRY_NODEF10(160), ERROR_ENTRY_NODEF10(170), ERROR_ENTRY_NODEF10(180), ERROR_ENTRY_NODEF10(190),
		ERROR_ENTRY_NODEF100(200), ERROR_ENTRY_NODEF100(300), ERROR_ENTRY_NODEF100(400), ERROR_ENTRY_NODEF100(500),
		ERROR_ENTRY_NODEF(600),	ERROR_ENTRY_NODEF(601),
		ERROR_ENTRY(602, "Ошибка в параметрах функции"),
		ERROR_ENTRY(603, "Ошибка в теле функции"),
		ERROR_ENTRY(604, "Ошибка в выражении"),
		ERROR_ENTRY(605, "Неверная структура програмы"),
		ERROR_ENTRY(606, "Ошибочный оператор"),
		ERROR_ENTRY(607, "Ошибка в выражении"),
		ERROR_ENTRY(608, "Ошибка в параметрах функции"),
		ERROR_ENTRY(609, "Ошибка в параметрах вызываемой функции"),
		ERROR_ENTRY(610,"Ошибка в операторе"),
		ERROR_ENTRY(611,"Ошибка в if"),
		ERROR_ENTRY(612,"Ошибка в операторе ifa"),
