...
#define GRAPH_CLOSE_PARENTHESIS 2, \
	FST::NODE(1,FST::RELATION(')',1)), \
	FST::NODE()
#define GRAPH_RAITIF 2, \
	FST::NODE(1,FST::RELATION('>',1)), \
	FST::NODE()
#define GRAPH_LEFTIF 2, \
	FST::NODE(1,FST::RELATION('<',1)), \
	FST::NODE()
#define GRAPH_SRAVN 2,\
	FST::NODE(1,FST::RELATION('@',1)), \
	FST::NODE()
#define GRAPH_NOSRAVN 2,\
	FST::NODE(1,FST::RELATION('^',1)), \
	FST::NODE()
#define GRAPH_PLUS 2, \
	FST::NODE(1,FST::RELATION('+',1)), \
